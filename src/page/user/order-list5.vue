<template>
  <div class="wrapper">
    ...
    <mt-navbar v-model="selected">
      <mt-tab-item id="1"><i class="iconfont icon-rongzi2"></i>我的持仓</mt-tab-item>
      <mt-tab-item id="2"><i class="iconfont icon-rongzilishi"></i>我的平仓</mt-tab-item>
    </mt-navbar>
    <mt-tab-container class="order-list" v-model="selected">
      <mt-tab-container-item id="1">
        ...
        <holdPositionHk :selectedNumber='selectedNumber' :handleOptions='handleOptions'/>
      ...
      <mt-tab-container-item id="2">
        ...
        <HistoryListHk :selectedNumber='selectedNumber' :hasChangeSell="hasChangeSell" :handleOptions='handleOptions'/>
      </mt-tab-container-item>
    </mt-tab-container>
    <foot></foot>
  </div>
...
import holdPositionHk from './compontents/hold-position-hk'
import HistoryListHk from './compontents/history-list-hk'

  ...
  <div class="wrapper">
    ...
    <div>
      <div class="box">
        <div class="box-contain clearfix">
          <div class="account text-center">
            ...
            <p class="red number">{{$store.state.userInfo.userCapital}}</p>
          </div>
        </div>
      </div>
      ...
      <div class="attention">
        ...
        <p>6、出金时段内提交出金后当日即可审核，出金到账时间受银行间清算时间影响，各家银行到账时间不同，最迟工作日72小时到账</p>
      </div>
...
export default {
  ...
  methods: {
    changeAllNumber () {
      this.number = this.$store.state.userInfo.userCapital
    },
